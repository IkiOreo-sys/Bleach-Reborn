...
public class EntityTenshoFX extends EntityFX
{
    ...
    public EntityTenshoFX(final World par1World, final double par2, final double par4, final double par6, final double par8, final double par10, final double par12) {
    ...
    public void onUpdate() {
        ...
        this.motionY *= 1.2959999978542327;
        this.motionZ = Math.cos(this.counter) * 0.1;
        this.moveEntity(this.motionX, this.motionY, this.motionZ);
        this.flameScale += 0.02f;
        if (this.onGround) {
