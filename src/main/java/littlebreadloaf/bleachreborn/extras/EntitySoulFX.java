...
public class EntitySoulFX extends EntityFX
{
    ...
    public EntitySoulFX(final World var1, final double var2, final double var4, final double var6, final float var8, final float var9, final float var10) {
        this(var1, var2, var4, var6, 1.0f, var8, var9, var10);
    }
    
    public EntitySoulFX(final World var1, final double var2, final double var4, final double var6, final float var8, float var9, final float var10, final float var11) {
