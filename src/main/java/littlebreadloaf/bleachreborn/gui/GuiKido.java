...
public class GuiKido extends GuiScreen
{
    ...
    public void drawScreen(final int x, final int y, final float f) {
        ...
        if (props.getKidoSkill() == 1) {
        	kname = "Bakudo 1: Sai";
        }
        else if (props.getKidoSkill() == 2) {
        	kname = "Hado 4: Byakurai";
        }
        else {
        	kname = "None";
        }
        this.fontRendererObj.drawString(EnumChatFormatting.RED + "Kido Skills", posX + 95, posY + 65, 0);
        this.fontRendererObj.drawString(EnumChatFormatting.RED + "Equipped Kido: " + kname, posX + 71, posY + 85, 0);
    ...
    public void initGui() {
        final int posX = (this.width - 256) / 2;
        final int posY = (this.height - 256) / 2;
        this.buttonList.add(new GuiButton(0, posX - 45, posY + 185, 35, 20, EnumChatFormatting.WHITE + "<-"));
        this.buttonList.add(new GuiButton(1, posX + 83, posY + 220, 76, 20, EnumChatFormatting.WHITE + "Close"));
        this.buttonList.add(new GuiButton(2, posX + 30, posY + 125, 76, 20, EnumChatFormatting.WHITE + "Hadou"));
        this.buttonList.add(new GuiButton(3, posX + 135, posY + 125, 76, 20, EnumChatFormatting.WHITE + "Bakudou"));
    }
    ...
    public void actionPerformed(final GuiButton button) {
        ...
        switch (button.id) {
            ...
            case 2: {
                this.mc.displayGuiScreen(new GuiHado());
            	break;
            }
            case 3: {
                this.mc.displayGuiScreen(new GuiBaku());
            	break;
            }
        }
