...
public class GuiAttack extends GuiScreen
{
    ...
    public void drawScreen(final int x, final int y, final float f) {
        ...
        this.fontRendererObj.drawString(EnumChatFormatting.GREEN + "Attacking Skills", posX + 91, posY + 65, 0);
    ...
    public void initGui() {
        ...
        final int posX = (this.width - 256) / 2;
        final int posY = (this.height - 256) / 2;
        this.buttonList.add(new GuiButton(0, posX + 56, posY + 100, 140, 20, EnumChatFormatting.WHITE + "Attack Reject | Level: " + props.getSkill1alevel()));
    ...
    public void actionPerformed(final GuiButton button) {
        ...
        switch (button.id) {
            case 0: {
                PacketDispatcher.sendToServer(new FlashMessage(127));
            	break;
            }
            case 1: {
                PacketDispatcher.sendToServer(new FlashMessage(130));
            	break;
            }
            case 2: {
