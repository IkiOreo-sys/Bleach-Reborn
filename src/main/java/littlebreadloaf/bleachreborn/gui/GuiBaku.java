...
public class GuiBaku extends GuiScreen
{
    ...
    public void drawScreen(final int x, final int y, final float f) {
        ...
        this.fontRendererObj.drawString(EnumChatFormatting.YELLOW + "Bakudou", posX + 97, posY + 65, 0);
        this.fontRendererObj.drawString(EnumChatFormatting.YELLOW + "Kido Points: " + props.getKidoPoints(), posX + 82, posY + 90, 0);
        this.fontRendererObj.drawString(EnumChatFormatting.GREEN + "Bakudo 1: Sai - Level: " + props.getBakudo1Level() + " | Cost: " + props.getBakudo1Cost(), posX + 10, posY + 120, 0);
    ...
    public void actionPerformed(final GuiButton button) {
        ...
        switch (button.id) {
            ...
            case 1: {
                PacketDispatcher.sendToServer(new FlashMessage(132));
                break;
            }
            case 2: {
