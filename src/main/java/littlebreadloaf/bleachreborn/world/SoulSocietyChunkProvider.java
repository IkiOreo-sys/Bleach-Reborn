...
public class SoulSocietyChunkProvider implements IChunkProvider
{
    private Random rand;
    ...
    public SoulSocietyChunkProvider(final World world, final long seed, final boolean features) {
