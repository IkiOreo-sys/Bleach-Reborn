...
public class SoulSocietyWorldProvider extends WorldProvider
{
    public void registerWorldChunkManager() {
        ...
        if (FMLCommonHandler.instance().getSide() == Side.CLIENT) {
            this.setSkyRenderer((IRenderHandler)new SkyRendererSoulSociety());
        }
    }
    ...
    public IChunkProvider createChunkGenerator() {
        return (IChunkProvider)new SoulSocietyChunkProvider(this.worldObj, this.worldObj.getSeed(), true);
    }
