...
{
    public ItemMSchoolUniform(final ItemArmor.ArmorMaterial par2, final int par3, final int armorType) {
    ...
    public void registerIcons(final IIconRegister par1RegisterIcon) {
        if (this == Armor.MaleSchoolTop) {
            this.itemIcon = par1RegisterIcon.registerIcon("bleachreborn".toLowerCase() + ":mschool_top");
        }
        if (this == Armor.MaleSchoolBottom) {
            this.itemIcon = par1RegisterIcon.registerIcon("bleachreborn".toLowerCase() + ":mschool_bottom");
        }
    }
    ...
    public String getArmorTexture(final ItemStack stack, final Entity entity, final int slot, final String layer) {
        if (stack.getItem() == Armor.MaleSchoolTop) {
            return "bleachreborn".toLowerCase() + ":textures/models/armor/male_school_1.png";
        }
        if (stack.getItem() == Armor.MaleSchoolBottom) {
            return "bleachreborn".toLowerCase() + ":textures/models/armor/male_school_2.png";
        }
        return null;
    }
