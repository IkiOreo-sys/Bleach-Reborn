...
public class BankaiWind extends ItemBankai
{
    ...
    public BankaiWind(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiWind_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiWind.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiWind.icons = new IIcon[BankaiWind.ICON.length];
        for (int i = 0; i < BankaiWind.icons.length; ++i) {
            BankaiWind.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiWind.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiWind.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.BankaiWind_UnlocalizedName;
    }
}
