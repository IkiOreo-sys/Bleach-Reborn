...
public class BankaiWater extends ItemBankai
{
    ...
    public BankaiWater(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiWater_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiWater.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiWater.icons = new IIcon[BankaiWater.ICON.length];
        for (int i = 0; i < BankaiWater.icons.length; ++i) {
            BankaiWater.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiWater.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiWater.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.BankaiWater_UnlocalizedName;
    }
}
