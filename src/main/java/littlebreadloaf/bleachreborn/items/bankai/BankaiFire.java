...
public class BankaiFire extends ItemBankai
{
    ...
    public BankaiFire(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiFire_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiFire.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiFire.icons = new IIcon[BankaiFire.ICON.length];
        for (int i = 0; i < BankaiFire.icons.length; ++i) {
            BankaiFire.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiFire.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiFire.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.BankaiFire_UnlocalizedName;
    }
}
