...
public class BankaiLight extends ItemBankai
{
    ...
    public BankaiLight(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiLight_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiLight.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiLight.icons = new IIcon[BankaiLight.ICON.length];
        for (int i = 0; i < BankaiLight.icons.length; ++i) {
            BankaiLight.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiLight.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiLight.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.BankaiLight_UnlocalizedName;
    }
}
