...
public class BankaiDark extends ItemBankai
{
    ...
    public BankaiDark(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiDark_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiDark.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiDark.icons = new IIcon[BankaiDark.ICON.length];
        for (int i = 0; i < BankaiDark.icons.length; ++i) {
            BankaiDark.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiDark.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiDark.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.BankaiDark_UnlocalizedName;
    }
}
