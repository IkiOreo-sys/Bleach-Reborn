...
public class BankaiEarth extends ItemBankai
{
    ...
    public BankaiEarth(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiEarth_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiEarth.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiEarth.icons = new IIcon[BankaiEarth.ICON.length];
        for (int i = 0; i < BankaiEarth.icons.length; ++i) {
            BankaiEarth.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiEarth.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiEarth.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    
    public void onPlayerStoppedUsing(final ItemStack var1, final World var2, final EntityPlayer var3, final int var4) {
    	if (!var2.isRemote) {
            PacketDispatcher.sendToAll((IMessage)new ParticleMessage(6, var3.posX, var3.posY, var3.posZ));
    	}
    }
    ...
    static {
        ICON = Names.BankaiEarth_UnlocalizedName;
    }
}
