...
public class BankaiLightning extends ItemBankai
{
    ...
    public BankaiLightning(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiLightning_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiLightning.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiLightning.icons = new IIcon[BankaiLightning.ICON.length];
        for (int i = 0; i < BankaiLightning.icons.length; ++i) {
            BankaiLightning.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiLightning.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiLightning.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.BankaiLightning_UnlocalizedName;
    }
}
