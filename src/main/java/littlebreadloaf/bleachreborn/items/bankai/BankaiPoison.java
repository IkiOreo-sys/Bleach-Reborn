...
public class BankaiPoison extends ItemBankai
{
    ...
    public BankaiPoison(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiPoison_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiPoison.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiPoison.icons = new IIcon[BankaiPoison.ICON.length];
        for (int i = 0; i < BankaiPoison.icons.length; ++i) {
            BankaiPoison.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiPoison.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiPoison.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.BankaiPoison_UnlocalizedName;
    }
}
