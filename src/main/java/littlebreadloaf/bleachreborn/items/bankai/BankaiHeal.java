...
public class BankaiHeal extends ItemBankai
{
    ...
    public BankaiHeal(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiHeal_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiHeal.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiHeal.icons = new IIcon[BankaiHeal.ICON.length];
        for (int i = 0; i < BankaiHeal.icons.length; ++i) {
            BankaiHeal.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiHeal.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiHeal.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.BankaiHeal_UnlocalizedName;
    }
}
