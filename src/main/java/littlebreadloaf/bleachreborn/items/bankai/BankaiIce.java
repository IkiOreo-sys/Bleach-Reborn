...
public class BankaiIce extends ItemBankai
{
    ...
    public BankaiIce(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiIce_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiIce.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiIce.icons = new IIcon[BankaiIce.ICON.length];
        for (int i = 0; i < BankaiIce.icons.length; ++i) {
            BankaiIce.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiIce.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiIce.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.BankaiIce_UnlocalizedName;
    }
}
