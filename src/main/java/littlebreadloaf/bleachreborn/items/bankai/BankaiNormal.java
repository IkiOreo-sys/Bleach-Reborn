...
public class BankaiNormal extends ItemBankai
{
    ...
    public BankaiNormal(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.BankaiNormal_UnlocalizedName[0];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return BankaiNormal.icons[0];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        BankaiNormal.icons = new IIcon[BankaiNormal.ICON.length];
        for (int i = 0; i < BankaiNormal.icons.length; ++i) {
            BankaiNormal.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + BankaiNormal.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(BankaiNormal.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
