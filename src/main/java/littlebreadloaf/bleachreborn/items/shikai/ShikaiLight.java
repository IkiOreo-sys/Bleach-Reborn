...
public class ShikaiLight extends ItemShikai
{
    ...
    public ShikaiLight(final Item.ToolMaterial material) {
        super(material);
    ...
    public String getUnlocalizedName(final ItemStack itemstack) {
        return Names.ShikaiLight_UnlocalizedName[itemstack.getItemDamage()];
    }
    ...
    public IIcon getIconFromDamage(final int damage) {
        return ShikaiLight.icons[damage];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        ShikaiLight.icons = new IIcon[ShikaiLight.ICON.length];
        for (int i = 0; i < ShikaiLight.icons.length; ++i) {
            ShikaiLight.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + ShikaiLight.ICON[i]);
        }
    }
    ...
    public boolean hitEntity(final ItemStack par1ItemStack, final EntityLivingBase par2EntityLivingBase, final EntityLivingBase par3EntityLivingBase) {
        ...
        final float damage = this.damageBoost + this.sandalboost + this.pantboost + this.robeboost + this.lightboost;
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(ShikaiLight.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    public void onPlayerStoppedUsing(final ItemStack var1, final World var2, final EntityPlayer var3, final int var4) {
        ...
        if (var6 >= 0.1) {
            ...
            if (var6 == 1.0f) {
                var3.addPotionEffect(new PotionEffect(Potion.invisibility.id, 600, 2));
    ...
    static {
        ICON = Names.ShikaiLight_UnlocalizedName;
    }
}
