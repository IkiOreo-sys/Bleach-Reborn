...
public class ShikaiNormal extends ItemShikai
{
    ...
    public ShikaiNormal(final Item.ToolMaterial material) {
        super(material);
    ...
    public IIcon getIconFromDamage(final int damage) {
        return ShikaiNormal.icons[damage];
    }
    
    @SideOnly(Side.CLIENT)
    public void registerIcons(final IIconRegister icon) {
        ShikaiNormal.icons = new IIcon[ShikaiNormal.ICON.length];
        for (int i = 0; i < ShikaiNormal.icons.length; ++i) {
            ShikaiNormal.icons[i] = icon.registerIcon("bleachreborn".toLowerCase() + ":" + ShikaiNormal.ICON[i]);
        }
    }
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        multimap.put((Object)SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), (Object)new AttributeModifier(ShikaiNormal.field_111210_e, "Weapon modifier", (double)damage, 0));
        return multimap;
    }
    ...
    static {
        ICON = Names.ShikaiNormal_UnlocalizedName;
    }
}
