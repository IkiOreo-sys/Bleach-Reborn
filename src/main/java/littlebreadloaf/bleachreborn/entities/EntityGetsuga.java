...
public class EntityGetsuga extends Entity implements IProjectile
{
    ...
    public EntityGetsuga(final World var1) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityGetsuga(final World var1, final double var2, final double var4, final double var6) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityGetsuga(final World var1, final EntityLiving var2, final EntityLiving var3, final float var4, final float var5) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityGetsuga(final World var1, final EntityLivingBase var2, final float var3) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
            ...
            for (int ar4 = -1; ar4 <= 1; ++ar4) {
                for (int ar5 = -1; ar5 <= 1; ++ar5) {
                    for (int ar6 = -2; ar6 <= 2; ++ar6) {
                        ...
                        if (this.rand.nextBoolean() && !this.worldObj.isRemote && this.shootingEntity instanceof EntityPlayer) {
                            PacketDispatcher.sendToAll((IMessage)new ParticleMessage(0, ar7, ar8, ar9));
                        }
                        if (!this.worldObj.isRemote && ar10 != null && ar10 != Blocks.bedrock && ar10 != Blocks.obsidian && ar10 != Blocks.portal && ar10 != BleachBlocks.reiatsuBlock && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")) {
