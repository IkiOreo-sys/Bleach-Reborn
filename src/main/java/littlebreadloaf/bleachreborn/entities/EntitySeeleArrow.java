...
public class EntitySeeleArrow extends Entity implements IProjectile
{
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntitySeeleArrow(final World var1) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntitySeeleArrow(final World var1, final double var2, final double var4, final double var6) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntitySeeleArrow(final World var1, final EntityLiving var2, final EntityLiving var3, final float var4, final float var5) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntitySeeleArrow(final World var1, final EntityLivingBase var2, final float var3) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public void onUpdate() {
        ...
        for (int ar4 = -1; ar4 <= 1; ++ar4) {
            for (int ar5 = -1; ar5 <= 1; ++ar5) {
                for (int ar6 = -2; ar6 <= 0; ++ar6) {
                    final int ar7 = ar2 + ar4;
                    final int ar8 = ar1 + ar6;
                    final int ar9 = ar3 + ar5;
                    final Block ar10 = this.worldObj.getBlock(ar7, ar8, ar9);
                    if (ar10 != null && (ar10 == Blocks.cactus || ar10 == Blocks.carrots || ar10 == Blocks.wheat || ar10 == Blocks.deadbush || ar10 == Blocks.cocoa || ar10 == Blocks.ice || ar10 == Blocks.leaves || ar10 == Blocks.leaves2 || ar10 == Blocks.brown_mushroom_block || ar10 == Blocks.melon_stem || ar10 == Blocks.potatoes || ar10 == Blocks.pumpkin_stem || ar10 == Blocks.red_mushroom_block || ar10 == Blocks.reeds || ar10 == Blocks.snow_layer || ar10 == Blocks.vine || ar10 == Blocks.waterlily || ar10 == Blocks.web || ar10 == Blocks.brown_mushroom || ar10 == Blocks.yellow_flower || ar10 == Blocks.tallgrass || ar10 == Blocks.red_mushroom || ar10 == Blocks.red_flower)) {
                        final int ar11 = this.worldObj.getBlockMetadata(ar7, ar8, ar9);
                        this.worldObj.setBlockToAir(ar7, ar8, ar9);
                    }
                    if (ar10 != null && ar10 == Blocks.grass) {
                        final int ar11 = this.worldObj.getBlockMetadata(ar7, ar8, ar9);
                        this.worldObj.setBlock(ar7, ar8, ar9, Blocks.dirt, 0, 0);
                    }
                }
            }
        }
        ...
        if (velocityy < 1.8) {
            if (!this.worldObj.isRemote) {
                this.dropItem(BleachItems.seele, 1);
            }
            this.setDead();
        }
        if (this.prevRotationPitch == 0.0f && this.prevRotationYaw == 0.0f) {
        ...
        if (this.inGround) {
            ...
            if (var4 != null) {
                if (var4.entityHit != null) {
                    if (var4.entityHit instanceof EntityLivingBase && ((EntityLivingBase)var4.entityHit).getCreatureAttribute() == Tools.SPIRIT) {
                        ((EntityLivingBase)var4.entityHit).setHealth(((EntityLivingBase)var4.entityHit).getHealth() - 20.0f);
                    }
                    if (!this.worldObj.isRemote) {
                        this.worldObj.createExplosion((Entity)this, this.posX, this.posY, this.posZ, 1.0f, this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"));
                    }
                    this.ticksInAir = 495;
                    if (!this.worldObj.isRemote) {
                        this.dropItem(BleachItems.seele, 1);
                        ...
                        if (((EntityLivingBase)var4.entityHit).getCreatureAttribute() == Tools.SPIRIT) {
                            if (this.shootingEntity instanceof EntityPlayer) {
                                ...
                                if (props.getFaction() == 2) {
                                    final double spirit = (props.getCurrentCap() * (double)props.getCurrentEnergy() / 10.0) + 10;
                            ...
                            this.damageboost = 0.0;
                            if (props.getFaction() == 2) {
                                final double spirit = (props.getCurrentCap() * (double)props.getCurrentEnergy() / 40.0) + 10;
                                final double ddamage = this.damageboost + this.robeboost + this.sandalboost + this.pantboost + spirit;
                                ((EntityLivingBase)var4.entityHit).setHealth(((EntityLivingBase)var4.entityHit).getHealth() - (float)ddamage);
                            }
                        }
