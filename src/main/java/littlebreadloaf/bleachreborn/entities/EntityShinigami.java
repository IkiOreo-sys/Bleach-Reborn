...
public class EntityShinigami extends EntityMob
{
    ...
    public EntityShinigami(final World par1) {
        this(par1, EntityShinigami.rand.nextInt(11));
    }
    
    public EntityShinigami(final World par1World, final int par2) {
        super(par1World);
    ...
    public ItemStack getHeldItem() {
        return EntityShinigami.heldItem;
    }
    ...
    protected String getHurtSound() {
        if (EntityShinigami.rand.nextInt(100) >= 50) {
            return null;
        }
        return null;
    }
    ...
    protected String getLivingSound() {
        if (EntityShinigami.rand.nextInt(100) >= 25) {
            return null;
        }
        return null;
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        this.entityDropItem(new ItemStack(BleachItems.reiatsu, 2 + EntityShinigami.rand.nextInt(3) + par2), 0.0f);
        if (EntityShinigami.rand.nextInt(50 - par2) == 0) {
            this.dropItem(BleachItems.zanpakuto, 1);
        }
        if (EntityShinigami.rand.nextInt(150 - par2) == 0) {
    ...
    public void onDeath(final DamageSource par1DamageSource) {
        ...
        if (par1DamageSource.getEntity() instanceof EntityPlayer) {
            ...
            if (var8 != null && var8.getItem() == Armor.HollowHelmet && EntityShinigami.rand.nextInt(20) == 0) {
    ...
    static {
        EntityShinigami.rand = new Random();
