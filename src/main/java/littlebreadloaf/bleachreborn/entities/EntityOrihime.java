...
public class EntityOrihime extends EntityMob
{
    private static Random rand;
    private boolean angry;
    private Item ditem;
    
    public EntityOrihime(final World par1) {
        this(par1, EntityOrihime.rand.nextInt(11));
    }
    
    public EntityOrihime(final World par1World, final int par2) {
        super(par1World);
    ...
    protected String getHurtSound() {
        if (EntityOrihime.rand.nextInt(100) >= 50) {
            return null;
        }
        return null;
    }
    ...
    protected String getLivingSound() {
        if (EntityOrihime.rand.nextInt(100) >= 25) {
            return null;
        }
        return null;
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        this.entityDropItem(new ItemStack(BleachItems.reiatsu, 2 + EntityOrihime.rand.nextInt(3) + par2), 0.0f);
        this.entityDropItem(new ItemStack(BleachItems.hairclip, 1), 0.0f);
    }
    ...
    public void onDeath(final DamageSource par1DamageSource) {
        ...
        if (par1DamageSource.getEntity() instanceof EntityPlayer) {
            ...
            if (props.getFaction() == 6) {
                this.ditem = BleachItems.hairclip;
            }
