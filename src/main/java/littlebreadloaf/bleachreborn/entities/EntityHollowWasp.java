...
public class EntityHollowWasp extends EntityMob
{
    ...
    public EntityHollowWasp(final World par1) {
        this(par1, EntityHollowWasp.rand.nextInt(4));
    }
    
    public EntityHollowWasp(final World par1World, final int par2) {
        super(par1World);
    ...
    protected void applyEntityAttributes() {
        ...
        if (this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) {
            this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(ConfigHandler.waspHP);
    ...
    protected String getHurtSound() {
        if (EntityHollowWasp.rand.nextInt(100) >= 50) {
    ...
    protected String getLivingSound() {
        if (EntityHollowWasp.rand.nextInt(100) >= 25) {
            return "bleachreborn:hollowscream";
        }
        return null;
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        this.entityDropItem(new ItemStack(BleachItems.reiatsu, 2 + EntityHollowWasp.rand.nextInt(3) + par2), 0.0f);
        if (EntityHollowWasp.rand.nextInt(20 - par2) == 0) {
            this.dropItem(Armor.WaspHelmet, 1);
        }
    }
    ...
    public boolean attackEntityAsMob(final Entity par1Entity) {
        if (super.attackEntityAsMob(par1Entity)) {
            if (par1Entity instanceof EntityPlayer) {
                final ExtendedPlayer props = (ExtendedPlayer)((EntityPlayer)par1Entity).getExtendedProperties("BleachPlayer");
                byte b0 = 0;
    ...
    public void onUpdate() {
        ...
        else if (this.currentFlightTarget == null || EntityHollowWasp.rand.nextInt(30) == 0 || this.currentFlightTarget.getDistanceSquared((int)this.posX, (int)this.posY, (int)this.posZ) < 4.0f) {
            this.currentFlightTarget = new ChunkCoordinates((int)this.posX + EntityHollowWasp.rand.nextInt(10) - EntityHollowWasp.rand.nextInt(10), (int)this.posY + EntityHollowWasp.rand.nextInt(9) - 2, (int)this.posZ + EntityHollowWasp.rand.nextInt(10) - EntityHollowWasp.rand.nextInt(10));
        }
        ...
        this.motionX += (Math.signum(d0) * 0.5 - this.motionX) * 0.07000000014901162;
        this.motionY += (Math.signum(d2) * 0.699999988079071 - this.motionY) * 0.07000000014901162;
        this.motionZ += (Math.signum(d3) * 0.5 - this.motionZ) * 0.07000000014901162;
    ...
    static {
        EntityHollowWasp.rand = new Random();
    }
}
