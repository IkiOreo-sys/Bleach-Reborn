...
public class EntityBleachAIFollowOwner extends EntityAIBase
{
    ...
    public EntityBleachAIFollowOwner(EntityTameable p_i1625_1_, double p_i1625_2_, float p_i1625_4_, float p_i1625_5_)
    {
