...
public class EntityBleachAIAttackOnCollide extends EntityAIBase
{
    ...
    public EntityBleachAIAttackOnCollide(EntityTameable pet, EntityCreature p_i1635_1_, Class p_i1635_2_, double p_i1635_3_, boolean p_i1635_5_)
    {
        this(pet, p_i1635_1_, p_i1635_3_, p_i1635_5_);
        this.classTarget = p_i1635_2_;
    }

    public EntityBleachAIAttackOnCollide(EntityTameable pet, EntityCreature p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_)
    {
    	this.thePet = pet;
    ...
    public boolean shouldExecute()
    {
        ...
        ExtendedPlayer props = ExtendedPlayer.get((EntityPlayer) owner);
        ...
        else if (props.getAutofarm() == 0) {
        	return false;
        }
        else if (props.getStay() == 1) {
        	return false;
        }
        else
        {
