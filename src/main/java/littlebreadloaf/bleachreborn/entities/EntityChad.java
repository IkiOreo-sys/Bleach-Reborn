...
public class EntityChad extends EntityMob
{
    private static Random rand;
    private boolean angry;
    private Item ditem;
    
    public EntityChad(final World par1) {
        this(par1, EntityChad.rand.nextInt(11));
    }
    
    public EntityChad(final World par1World, final int par2) {
        super(par1World);
    ...
    protected String getHurtSound() {
        if (EntityChad.rand.nextInt(100) >= 50) {
            return null;
        }
        return null;
    }
    ...
    protected String getLivingSound() {
        if (EntityChad.rand.nextInt(100) >= 25) {
            return null;
        }
        return null;
    }
    ...
    protected void dropFewItems(final boolean par1, final int par2) {
        ...
        this.entityDropItem(new ItemStack(BleachItems.reiatsu, 2 + EntityChad.rand.nextInt(3) + par2), 0.0f);
        this.entityDropItem(new ItemStack(BleachItems.diablo, 1), 0.0f);
    }
