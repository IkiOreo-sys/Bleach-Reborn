...
public class EntityHCArrow extends Entity implements IProjectile
{
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityHCArrow(final World var1) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityHCArrow(final World var1, final double var2, final double var4, final double var6) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityHCArrow(final World var1, final EntityLiving var2, final EntityLiving var3, final float var4, final float var5) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityHCArrow(final World var1, final EntityLivingBase var2, final float var3) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
                ...
                if (var4.entityHit != null) {
                    ...
                    if (var4.entityHit instanceof EntityLivingBase) {
                        if (((EntityLivingBase)var4.entityHit).getCreatureAttribute() == Tools.SPIRIT && this.shootingEntity instanceof EntityPlayer) {
                            final ExtendedPlayer props = (ExtendedPlayer)player.getExtendedProperties("BleachPlayer");
                            if (!player.worldObj.isRemote && props.getFaction() == 17) {
                                props.addSXP(5 * props.getXpRate());
                            }
                            this.damageboost = 3.0;
                            if (props.getFaction() == 17) {
                                final double spirit = (props.getCurrentCap() * (double)props.getCurrentEnergy() / 28.0) + 10;
                        ...
                        if (this.shootingEntity instanceof EntityPlayer) {
                            ...
                            this.damageboost = 0.0;
                            if (props.getFaction() == 17) {
                                final double spirit = (props.getCurrentCap() * (double)props.getCurrentEnergy() / 30.0) + 10;
                                final double ddamage = this.damageboost + this.robeboost + this.sandalboost + this.pantboost + spirit;
