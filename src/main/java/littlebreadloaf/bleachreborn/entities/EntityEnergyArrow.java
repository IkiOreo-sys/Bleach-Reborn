...
public class EntityEnergyArrow extends Entity implements IProjectile
{
    ...
    public EntityEnergyArrow(final World var1) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityEnergyArrow(final World var1, final double var2, final double var4, final double var6) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityEnergyArrow(final World var1, final EntityLiving var2, final EntityLiving var3, final float var4, final float var5) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityEnergyArrow(final World var1, final EntityLivingBase var2, final float var3) {
        super(var1);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
                    ...
                    if (var4.entityHit instanceof EntityLivingBase) {
                        if (((EntityLivingBase)var4.entityHit).getCreatureAttribute() == Tools.SPIRIT && this.shootingEntity instanceof EntityPlayer) {
                            ...
                            if (props.getFaction() == 2) {
                                final double spirit = (props.getCurrentCap() * (double)props.getCurrentEnergy() / 15.0) + 10;
                        ...
                        if (this.shootingEntity instanceof EntityPlayer) {
                            final ExtendedPlayer props = (ExtendedPlayer)player.getExtendedProperties("BleachPlayer");
                            if (!player.worldObj.isRemote && props.getFaction() == 2) {
                                props.addSXP(3 * props.getXpRate());
                            }
                            this.damageboost = 0.0;
                            if (props.getFaction() == 2) {
