...
import littlebreadloaf.bleachreborn.render.models.ModelMenosGrande;


public class RenderPH extends RenderPlayer {
    
    public ResourceLocation texture = new ResourceLocation("bleachreborn".toLowerCase() + ":textures/models/mobs/phollow.png");
    public ResourceLocation texture1 = new ResourceLocation("bleachreborn".toLowerCase() + ":textures/models/mobs/menos.png");
    
    public ModelBiped tutModel;
    public ModelMenosGrande tModel;
    ...
    public RenderPH() {
        ...
        this.tModel = new ModelMenosGrande();
    }
    ...
    public void renderModel(EntityLivingBase entity, float par2, float par3, float par4, float par5, float par6, float par7) {
        ...
        if(entity instanceof EntityPlayer && ExtendedPlayer.get((EntityPlayer) entity).getFaction() == 3) {
        ...
        } else if(entity instanceof EntityPlayer && ExtendedPlayer.get((EntityPlayer) entity).getFaction() == 7) {
            ModelMenosGrande modelBiped;
            for(int i = 0;i < 4;++i) {
                modelBiped = this.tModel;
