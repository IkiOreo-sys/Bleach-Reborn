...
public class ModelHollowBlaze extends ModelBase
{
    private ModelRenderer[] blazeSticks;
    private ModelRenderer blazeHead;
    
    public ModelHollowBlaze() {
        this.blazeSticks = new ModelRenderer[18];
        for (int var1 = 0; var1 < this.blazeSticks.length; ++var1) {
            (this.blazeSticks[var1] = new ModelRenderer((ModelBase)this, 0, 16)).addBox(0.0f, 0.0f, 0.0f, 2, 8, 2);
        }
        (this.blazeHead = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-4.0f, -4.0f, -4.0f, 8, 8, 8);
    }
