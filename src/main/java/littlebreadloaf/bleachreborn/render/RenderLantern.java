...
public class RenderLantern extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler
{
    ...
    static {
        RenderLantern.model = new ModelBase() {};
    }
}
