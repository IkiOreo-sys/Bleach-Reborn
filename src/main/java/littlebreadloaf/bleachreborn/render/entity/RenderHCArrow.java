...
public class RenderHCArrow extends Render
{
    private static final ResourceLocation arrowTextures;
    
    public void renderEnergyArrow(final EntityHCArrow par1EntityEnergyArrow, final double par2, final double par4, final double par6, final float par8, final float par9) {
        this.bindEntityTexture((Entity)par1EntityEnergyArrow);
        GL11.glPushMatrix();
        ...
        GL11.glRotatef(par1EntityEnergyArrow.prevRotationPitch + (par1EntityEnergyArrow.rotationPitch - par1EntityEnergyArrow.prevRotationPitch) * par9, 0.0f, 0.0f, 1.0f);
        ...
        GL11.glEnable(32826);
        final float f11 = par1EntityEnergyArrow.arrowShake - par9;
        if (f11 > 0.0f) {
    ...
    protected ResourceLocation getArrowTextures(final EntityHCArrow par1EntityEnergyArrow) {
        return RenderHCArrow.arrowTextures;
    }
    
    protected ResourceLocation getEntityTexture(final Entity par1Entity) {
        return this.getArrowTextures((EntityHCArrow)par1Entity);
    }
    
    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6, final float par8, final float par9) {
        this.renderEnergyArrow((EntityHCArrow)par1Entity, par2, par4, par6, par8, par9);
    }
    
    static {
        arrowTextures = new ResourceLocation("bleachreborn".toLowerCase() + ":textures/items/hcarrows.png");
    }
}
