...
public class RenderEnergyArrow extends Render
{
    ...
    public void renderEnergyArrow(final EntityEnergyArrow par1EntityEnergyArrow, final double par2, final double par4, final double par6, final float par8, final float par9) {
    ...
    protected ResourceLocation getArrowTextures(final EntityEnergyArrow par1EntityEnergyArrow) {
        return RenderEnergyArrow.arrowTextures;
    }
    ...
    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6, final float par8, final float par9) {
        this.renderEnergyArrow((EntityEnergyArrow)par1Entity, par2, par4, par6, par8, par9);
    }
