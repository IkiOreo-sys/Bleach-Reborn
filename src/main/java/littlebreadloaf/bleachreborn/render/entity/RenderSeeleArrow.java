...
public class RenderSeeleArrow extends Render
{
    private static final ResourceLocation arrowTextures;
    
    public void renderSeeleArrow(final EntitySeeleArrow par1EntitySeeleArrow, final double par2, final double par4, final double par6, final float par8, final float par9) {
        this.bindEntityTexture((Entity)par1EntitySeeleArrow);
        GL11.glPushMatrix();
        ...
        GL11.glEnable(32826);
        final float f11 = par1EntitySeeleArrow.arrowShake - par9;
        if (f11 > 0.0f) {
    ...
    protected ResourceLocation getArrowTextures(final EntitySeeleArrow par1EntitySeeleArrow) {
        return RenderSeeleArrow.arrowTextures;
    }
    ...
    public void doRender(final Entity par1Entity, final double par2, final double par4, final double par6, final float par8, final float par9) {
        this.renderSeeleArrow((EntitySeeleArrow)par1Entity, par2, par4, par6, par8, par9);
    }
    
    static {
        arrowTextures = new ResourceLocation("bleachreborn".toLowerCase() + ":textures/items/seelearrows.png");
    }
}
