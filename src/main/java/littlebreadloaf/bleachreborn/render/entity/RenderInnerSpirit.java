...
public class RenderInnerSpirit extends RenderBiped
{
    private static final ResourceLocation texture1;
    protected ModelBiped model;
    
    public RenderInnerSpirit(final ModelBiped par1ModelBiped, final float par2) {
    ...
    public void renderShinigami(final EntityInnerSpirit par1, final double par2, final double par3, final double par4, final float par5, final float par6) {
    ...
    public void doRender(final Entity par1, final double par2, final double par3, final double par4, final float par5, final float par6) {
        this.renderShinigami((EntityInnerSpirit)par1, par2, par3, par4, par5, par6);
    }
    ...
    static {
        texture1 = new ResourceLocation("bleachreborn".toLowerCase() + ":textures/models/mobs/innerspirit.png");
    }
}
