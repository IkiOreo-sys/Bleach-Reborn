...
public class BlockAdminBait extends Block
{
    ...
    protected BlockAdminBait() {
        super(Material.cake);
        this.setTickRandomly(this.var18 = false);
        this.rand = new Random();
        this.setCreativeTab(BleachItems.tabBleach);
        this.setBlockName("admin_bait");
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        this.blockIcon = par1IconRegister.registerIcon("bleachreborn".toLowerCase() + ":admin_bait2");
        this.field_94382_c = par1IconRegister.registerIcon("cake_inner");
        this.cakeTopIcon = par1IconRegister.registerIcon("bleachreborn".toLowerCase() + ":admin_bait");
        this.cakeBottomIcon = par1IconRegister.registerIcon("bleachreborn".toLowerCase() + ":admin_bait2");
    }
    ...
    public void updateTick(final World var1, final int var2, final int var3, final int var4, final Random var5) {
        ...
        if (this.baitTimer < 840) {
            ...
            var7.setLocationAndAngles((double)var16 + 10, (double)var17, (double)var18 - 15, 0.0f, 0.0f);
            var13.setLocationAndAngles((double)var16 + 10, (double)var17, (double)var18 - 7, 0.0f, 0.0f);
            var15.setLocationAndAngles((double)var16 - 10, (double)var17, (double)var18 + 5, 0.0f, 0.0f);
            final int randomHollows = this.rand.nextInt(45);
            if (randomHollows == 1) {
