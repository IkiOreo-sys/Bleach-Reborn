...
public class BlockHollowBait2 extends Block
{
    ...
    protected BlockHollowBait2() {
        super(Material.cake);
        this.setTickRandomly(this.var18 = false);
        this.rand = new Random();
        this.setCreativeTab(BleachItems.tabBleach);
        this.setBlockName("hollow_bait2");
    ...
    public void registerBlockIcons(final IIconRegister par1IconRegister) {
        this.blockIcon = par1IconRegister.registerIcon("bleachreborn".toLowerCase() + ":hollow_bait5");
        this.field_94382_c = par1IconRegister.registerIcon("cake_inner");
        this.cakeTopIcon = par1IconRegister.registerIcon("bleachreborn".toLowerCase() + ":hollow_bait4");
        this.cakeBottomIcon = par1IconRegister.registerIcon("bleachreborn".toLowerCase() + ":hollow_bait5");
    }
    ...
    public void updateTick(final World var1, final int var2, final int var3, final int var4, final Random var5) {
        ...
        if (this.baitTimer < 840) {
            ...
            final int randomHollows = this.rand.nextInt(35);
            final int randomMenos = this.rand.nextInt(1000);
            if (randomHollows == 0) {
